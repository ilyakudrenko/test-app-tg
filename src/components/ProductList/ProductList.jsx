import React, {useCallback, useEffect, useState} from 'react'; // Add useState here
...
const products = [
    ...
    {id: '2', title: 'Кроссфит 2', price: 1200, description: 'Супер Кроссфит курс'},
    {id: '3', title: 'Кроссфит 3', price: 112, description: 'Хороший Кроссфит курс'},
    {id: '4', title: 'Кроссфит 4', price: 4000, description: 'Супер Кроссфит курс'},
    {id: '5', title: 'Кроссфит 5', price: 600, description: 'Хороший Кроссфит курс'},
    {id: '6', title: 'Кроссфит 6', price: 900, description: 'Супер Кроссфит курс'},
    ...
    {id: '9', title: 'Кроссфит Бомба', price: 3000, description: 'Лучший курс'},
];
